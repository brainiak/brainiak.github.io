...
data_path = os.path.expanduser('~') + 'brainiak_datasets/'
...
results_path = os.path.expanduser('~') + 'brainiak_results/'

# Data path VDC dataset
vdc_data_dir = data_path + 'vdc/'
...
nb2_simulated_data = data_path + '02-data-handling-simulated-dataset/'

#constants for ninety six dataset
ns_data_dir = data_path + 'NinetySix/'
...
latatt_dir = data_path + 'latatt/'

# constants for the FCMA (face-scene) dataset
fs_data_dir = data_path + 'face_scene/'

# for Pieman2 dataset
pieman2_dir =  data_path + 'Pieman2/'

# for Raider dataset
raider_data_dir = data_path + 'raider/'

# for Sherlock dataset
sherlock_h5_data = data_path + 'sherlock_h5/'
sherlock_dir = data_path + 'Sherlock_processed/'
